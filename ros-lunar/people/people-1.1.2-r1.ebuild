...
SRC_URI="https://github.com/OSUrobotics/${PN}-release/archive/release/lunar/${PN}/1.1.2-1.tar.gz -> ${PN}-lunar-release-${PV}.tar.gz"

LICENSE="BSD"

KEYWORDS="~x86 ~amd64 ~arm ~arm64"
RDEPEND="
	ros-lunar/face_detector
	ros-lunar/leg_detector
	ros-lunar/people_msgs
	ros-lunar/people_tracking_filter
	ros-lunar/people_velocity_tracker
"
DEPEND="${RDEPEND}
	ros-lunar/catkin
"
