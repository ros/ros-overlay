...
SRC_URI="https://github.com/swri-robotics-gbp/novatel_gps_driver-release/archive/release/lunar/novatel_gps_driver/3.4.0-0.tar.gz -> ${PN}-lunar-release-${PV}.tar.gz"
