...
HOMEPAGE="https://jsk-visualization.readthedocs.io/en/latest/jsk_rqt_plugins/index.html"
SRC_URI="https://github.com/tork-a/jsk_visualization-release/archive/release/noetic/${PN}/2.1.8-1.tar.gz -> ${PN}-noetic-release-${PV}.tar.gz"
