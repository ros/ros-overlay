...
SRC_URI="https://github.com/mrpt-ros-pkg-release/${PN}-release/archive/release/noetic/${PN}/0.0.4-1.tar.gz -> ${PN}-noetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-noetic/mrpt_sensors_examples
"
DEPEND="${RDEPEND}
	ros-noetic/catkin
"
