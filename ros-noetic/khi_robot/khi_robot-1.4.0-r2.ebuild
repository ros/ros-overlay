...
SRC_URI="https://github.com/Kawasaki-Robotics/${PN}-release/archive/release/noetic/${PN}/1.4.0-2.tar.gz -> ${PN}-noetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-noetic/khi_rs025n_moveit_config
