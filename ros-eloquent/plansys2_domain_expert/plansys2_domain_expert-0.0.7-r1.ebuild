...
SRC_URI="https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/eloquent/${PN}/0.0.7-1.tar.gz -> ${PN}-eloquent-release-${PV}.tar.gz"
