...
SRC_URI="https://github.com/SteveMacenski/${PN}-release/archive/release/galactic/${PN}/1.0.12-1.tar.gz -> ${PN}-galactic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-galactic/nav2_rotation_shim_controller
	ros-galactic/nav2_rviz_plugins
	ros-galactic/nav2_smac_planner
	ros-galactic/nav2_theta_star_planner
