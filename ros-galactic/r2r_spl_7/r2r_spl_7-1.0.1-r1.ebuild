...
SRC_URI="https://github.com/ros2-gbp/r2r_spl-release/archive/release/galactic/${PN}/1.0.1-1.tar.gz -> ${PN}-galactic-release-${PV}.tar.gz"
...
RDEPEND="
	ros-galactic/rclpy
	ros-galactic/splsm_7_conversion
