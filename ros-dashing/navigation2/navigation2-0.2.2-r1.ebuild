...
SRC_URI="https://github.com/SteveMacenski/${PN}-release/archive/release/dashing/${PN}/0.2.2-1.tar.gz -> ${PN}-dashing-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-dashing/nav2_motion_primitives
