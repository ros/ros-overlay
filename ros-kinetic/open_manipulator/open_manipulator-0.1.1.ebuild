...
SRC_URI="https://github.com/ROBOTIS-GIT-release/${PN}-release/archive/release/kinetic/${PN}/0.1.1-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-kinetic/open_manipulator_with_tb3
"
DEPEND="${RDEPEND}
	ros-kinetic/catkin
"
