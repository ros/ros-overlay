...
SRC_URI="https://github.com/PilzDE/pilz_industrial_motion-release/archive/release/kinetic/${PN}/0.3.6-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
