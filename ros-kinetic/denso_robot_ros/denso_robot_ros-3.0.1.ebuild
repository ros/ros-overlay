...
DESCRIPTION="DENSO robot meta package"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/DENSORobot/${PN}-release/archive/release/kinetic/${PN}/3.0.1-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
