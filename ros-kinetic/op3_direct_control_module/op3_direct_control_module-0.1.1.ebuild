...
SRC_URI="https://github.com/ROBOTIS-GIT-release/ROBOTIS-OP3-release/archive/release/kinetic/op3_direct_control_module/0.1.1-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
