...
SRC_URI="https://github.com/PilzDE/pilz_robots-release/archive/release/kinetic/${PN}/0.4.5-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	test? ( ros-kinetic/moveit_kinematics )
