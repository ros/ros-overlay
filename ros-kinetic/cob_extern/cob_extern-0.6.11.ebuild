...
SRC_URI="https://github.com/ipa320/cob_extern-release/archive/release/kinetic/cob_extern/0.6.11-0.tar.gz -> ${PN}-release-${PV}.tar.gz"

LICENSE="( LGPL-2 CC-BY-SA-3.0 )"
KEYWORDS="~x86 ~amd64 ~arm ~arm64"
RDEPEND="
	ros-kinetic/libconcorde_tsp_solver
	ros-kinetic/libdlib
