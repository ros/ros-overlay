...
SRC_URI="https://github.com/uuvsimulator/${PN}-release/archive/release/kinetic/${PN}/0.6.1-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-kinetic/uuv_sensor_plugins_ros_msgs
