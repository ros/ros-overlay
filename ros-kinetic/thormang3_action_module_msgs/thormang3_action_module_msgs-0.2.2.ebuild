...
SRC_URI="https://github.com/ROBOTIS-GIT-release/ROBOTIS-THORMANG-msgs-release/archive/release/kinetic/thormang3_action_module_msgs/0.2.2-0.tar.gz -> ${P}-${PV}.tar.gz"
