...
DESCRIPTION="This package is a node that can playing mp3 file.
    This package is using madp"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/ROBOTIS-GIT-release/ROBOTIS-Utility-release/archive/release/kinetic/ros_madplay_player/0.1.2-0.tar.gz -> ${P}-${PV}.tar.gz"
