...
DESCRIPTION="Dynamixel-Workbench is dynamixel solution for ROS.\
	This metapackage allows y"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/ROBOTIS-GIT-release/dynamixel-workbench-release/archive/release/kinetic/dynamixel_workbench/0.1.6-0.tar.gz -> ${PN}-kinetic-release-${PV}.tar.gz"
