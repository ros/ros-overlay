...
SRC_URI="https://github.com/tork-a/${PN}-release/archive/release/melodic/${PN}/2.1.24-2.tar.gz -> ${PN}-melodic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	ros-melodic/google_cloud_texttospeech
	ros-melodic/julius
