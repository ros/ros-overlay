...
RDEPEND="
	...
	ros-melodic/tf2
	ros-melodic/tf2_kdl
	test? ( ros-melodic/moveit_resources_fanuc_description )
	test? ( ros-melodic/moveit_resources_fanuc_moveit_config )
	test? ( ros-melodic/moveit_resources_panda_description )
