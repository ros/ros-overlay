...
SRC_URI="https://github.com/ros-industrial-release/industrial_core-release/archive/release/melodic/${PN}/0.7.0-0.tar.gz -> ${PN}-melodic-release-${PV}.tar.gz"
...
RDEPEND="
	...
	test? ( ros-melodic/industrial_robot_client )
