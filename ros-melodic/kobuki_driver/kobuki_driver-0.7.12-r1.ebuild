...
SRC_URI="https://github.com/yujinrobot-release/kobuki_core-release/archive/release/melodic/${PN}/0.7.12-1.tar.gz -> ${PN}-melodic-release-${PV}.tar.gz"
