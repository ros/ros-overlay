...
SRC_URI="https://github.com/yujinrobot-release/rocon_concert-release/archive/release/indigo/concert_utilities/0.6.11-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
