...
DESCRIPTION="Common packages and data for the BuildingWide Intelligence	project of the U"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/utexas-bwi-gbp/bwi_common-release/archive/release/indigo/bwi_common/0.3.12-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
