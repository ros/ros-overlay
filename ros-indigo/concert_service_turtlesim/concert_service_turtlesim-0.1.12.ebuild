...
DESCRIPTION="Sets up the turtlesim engine as a service to assist in spawning/killing tur[...]"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/yujinrobot-release/concert_services-release/archive/release/indigo/concert_service_turtlesim/0.1.12-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
