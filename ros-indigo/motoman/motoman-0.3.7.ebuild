...
DESCRIPTION="The motoman stack constains libraries, configuration files, and ROS nodes f[...]"
HOMEPAGE="http://ros.org/wiki/motoman"
SRC_URI="https://github.com/ros-industrial-release/motoman-release/archive/release/indigo/motoman/0.3.7-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
