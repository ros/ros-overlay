...
SRC_URI="https://github.com/mrpt-ros-pkg-release/mrpt_navigation-release/archive/release/indigo/mrpt_navigation/0.1.14-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
