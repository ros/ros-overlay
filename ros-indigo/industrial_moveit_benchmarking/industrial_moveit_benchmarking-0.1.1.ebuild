...
SRC_URI="https://github.com/ros-industrial-release/industrial_moveit-release/archive/release/indigo/industrial_moveit_benchmarking/0.1.1-0.tar.gz -> ${P}-${PV}.tar.gz"
