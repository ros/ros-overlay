...
SRC_URI="https://github.com/yujinrobot-release/ecl_manipulation-release/archive/release/indigo/ecl_manipulators/0.60.1-2.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
