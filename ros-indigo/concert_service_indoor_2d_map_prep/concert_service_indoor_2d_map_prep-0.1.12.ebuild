...
SRC_URI="https://github.com/yujinrobot-release/concert_services-release/archive/release/indigo/concert_service_indoor_2d_map_prep/0.1.12-0.tar.gz -> ${P}-${PV}.tar.gz"
