...
SRC_URI="https://github.com/utexas-bwi-gbp/concert_scheduling-release/archive/release/indigo/concert_simple_scheduler/0.7.0-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
