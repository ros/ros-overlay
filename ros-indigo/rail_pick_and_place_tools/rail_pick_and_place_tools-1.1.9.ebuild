...
SRC_URI="https://github.com/gt-rail-release/rail_pick_and_place-release/archive/release/indigo/rail_pick_and_place_tools/1.1.9-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
