...
SRC_URI="https://github.com/tu-darmstadt-ros-pkg-gbp/hector_slam-release/archive/release/indigo/hector_geotiff_plugins/0.3.5-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
