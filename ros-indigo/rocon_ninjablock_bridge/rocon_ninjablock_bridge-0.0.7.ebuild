...
SRC_URI="https://github.com/yujinrobot-release/rocon_devices-release/archive/release/indigo/rocon_ninjablock_bridge/0.0.7-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
