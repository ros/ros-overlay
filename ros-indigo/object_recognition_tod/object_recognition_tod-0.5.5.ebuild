...
SRC_URI="https://github.com/ros-gbp/object_recognition_tod-release/archive/release/indigo/object_recognition_tod/0.5.5-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
