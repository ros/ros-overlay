...
SRC_URI="https://github.com/aleeper/interaction_cursor_3d-release/archive/release/indigo/interaction_cursor_3d/0.0.3-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
