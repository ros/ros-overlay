...
SRC_URI="https://github.com/tu-darmstadt-ros-pkg-gbp/hector_models-release/archive/release/indigo/hector_components_description/0.4.2-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
