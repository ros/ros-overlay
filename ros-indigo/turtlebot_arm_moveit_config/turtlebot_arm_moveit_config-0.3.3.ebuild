...
SRC_URI="https://github.com/turtlebot-release/turtlebot_arm-release/archive/release/indigo/turtlebot_arm_moveit_config/0.3.3-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
