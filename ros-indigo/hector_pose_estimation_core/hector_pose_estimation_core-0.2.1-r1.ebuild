...
SRC_URI="https://github.com/tu-darmstadt-ros-pkg-gbp/hector_localization-release/archive/release/indigo/hector_pose_estimation_core/0.2.1-1.tar.gz -> ${PN}-release-${PV}.tar.gz"
