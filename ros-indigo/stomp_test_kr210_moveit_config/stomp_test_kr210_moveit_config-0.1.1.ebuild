...
SRC_URI="https://github.com/ros-industrial-release/industrial_moveit-release/archive/release/indigo/stomp_test_kr210_moveit_config/0.1.1-0.tar.gz -> ${P}-${PV}.tar.gz"
