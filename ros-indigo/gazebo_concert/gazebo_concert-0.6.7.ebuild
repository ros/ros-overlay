...
DESCRIPTION="A simple software concert describing how multiple robots launched in	simulat"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/yujinrobot-release/rocon_tutorials-release/archive/release/indigo/gazebo_concert/0.6.7-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
