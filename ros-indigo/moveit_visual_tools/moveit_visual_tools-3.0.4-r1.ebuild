...
SRC_URI="https://github.com/davetcoleman/moveit_visual_tools-release/archive/release/indigo/moveit_visual_tools/3.0.4-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
