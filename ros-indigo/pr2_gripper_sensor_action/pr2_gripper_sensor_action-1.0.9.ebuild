...
HOMEPAGE="None"
SRC_URI="https://github.com/pr2-gbp/pr2_gripper_sensor-release/archive/release/indigo/pr2_gripper_sensor_action/1.0.9-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
