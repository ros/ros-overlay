...
DESCRIPTION="ROSIndustrial support for Fanuc manipulators metapackage"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/ros-industrial-release/fanuc-release/archive/release/indigo/fanuc/0.4.2-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
