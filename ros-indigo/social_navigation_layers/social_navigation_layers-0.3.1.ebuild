...
SRC_URI="https://github.com/wu-robotics/navigation_layers_release/archive/release/indigo/social_navigation_layers/0.3.1-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
