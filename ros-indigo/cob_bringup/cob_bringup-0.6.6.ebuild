...
DESCRIPTION="This package provides launch files for operating CareObot"
HOMEPAGE="http://ros.org/wiki/cob_bringup"
SRC_URI="https://github.com/ipa320/cob_robots-release/archive/release/indigo/cob_bringup/0.6.6-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
