...
SRC_URI="https://github.com/yujinrobot-release/rocon_tutorials-release/archive/release/indigo/rocon_app_manager_tutorials/0.6.7-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
