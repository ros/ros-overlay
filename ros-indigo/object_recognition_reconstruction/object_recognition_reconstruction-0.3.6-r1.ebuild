...
SRC_URI="https://github.com/ros-gbp/object_recognition_reconstruction-release/archive/release/indigo/object_recognition_reconstruction/0.3.6-1.tar.gz -> ${PN}-release-${PV}.tar.gz"
