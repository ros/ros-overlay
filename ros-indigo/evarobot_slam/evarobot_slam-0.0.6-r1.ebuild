...
DESCRIPTION="evarobot_slam provides roslaunch scripts for SLAM map building with the Eva[...]"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/inomuh/evapc_ros-release/archive/release/indigo/evarobot_slam/0.0.6-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
