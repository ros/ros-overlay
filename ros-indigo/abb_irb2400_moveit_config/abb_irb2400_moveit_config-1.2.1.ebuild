...
SRC_URI="https://github.com/ros-industrial-release/abb-release/archive/release/indigo/abb_irb2400_moveit_config/1.2.1-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
