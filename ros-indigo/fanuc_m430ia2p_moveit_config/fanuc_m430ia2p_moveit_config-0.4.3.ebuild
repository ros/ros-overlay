...
SRC_URI="https://github.com/ros-industrial-release/fanuc-release/archive/release/indigo/fanuc_m430ia2p_moveit_config/0.4.3-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
