...
SRC_URI="https://github.com/yujinrobot-release/concert_services-release/archive/release/indigo/concert_services/0.1.12-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
