...
SRC_URI="https://github.com/ros-industrial-release/fanuc-release/archive/release/indigo/fanuc_lrmate200ic5h_moveit_config/0.4.2-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
