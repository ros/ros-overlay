...
SRC_URI="https://github.com/davetcoleman/moveit_sim_controller-release/archive/release/indigo/moveit_sim_controller/0.0.5-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
