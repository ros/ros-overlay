...
SRC_URI="https://github.com/ros-aldebaran/romeo_moveit_config-release/archive/release/indigo/romeo_moveit_config/0.2.7-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
