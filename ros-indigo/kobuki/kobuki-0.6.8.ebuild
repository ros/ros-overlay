...
DESCRIPTION="Software for Kobuki, Yujin Robots mobile research base"
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://github.com/yujinrobot-release/kobuki-release/archive/release/indigo/kobuki/0.6.8-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
