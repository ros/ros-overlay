...
SRC_URI="https://github.com/shadow-robot/sr-visualization-release/archive/release/indigo/sr_gui_change_muscle_controllers/1.3.1-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
