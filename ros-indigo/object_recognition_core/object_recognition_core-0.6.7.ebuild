...
SRC_URI="https://github.com/ros-gbp/object_recognition_core-release/archive/release/indigo/object_recognition_core/0.6.7-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
