...
SRC_URI="https://github.com/yujinrobot-release/message_multiplexing-release/archive/release/indigo/message_multiplexing/0.2.4-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
