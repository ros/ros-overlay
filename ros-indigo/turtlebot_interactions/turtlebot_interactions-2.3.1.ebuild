...
SRC_URI="https://github.com/turtlebot-release/turtlebot_interactions-release/archive/release/indigo/turtlebot_interactions/2.3.1-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
