...
SRC_URI="https://github.com/yujinrobot-release/rocon_multimaster-release/archive/release/indigo/rocon_hub_client/0.7.10-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
