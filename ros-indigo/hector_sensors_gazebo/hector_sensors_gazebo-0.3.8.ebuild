...
SRC_URI="https://github.com/tu-darmstadt-ros-pkg-gbp/hector_gazebo-release/archive/release/indigo/hector_sensors_gazebo/0.3.8-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
