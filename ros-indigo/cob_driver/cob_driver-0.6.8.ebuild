...
DESCRIPTION="The cob_driver stack includes packages that provide access to the CareObot har"
HOMEPAGE="http://ros.org/wiki/cob_driver"
SRC_URI="https://github.com/ipa320/cob_driver-release/archive/release/indigo/cob_driver/0.6.8-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
