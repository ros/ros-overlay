...
SRC_URI="https://github.com/yujinrobot-release/rocon_concert-release/archive/release/indigo/concert_service_link_graph/0.6.11-1.tar.gz -> ${PN}-release-${PV}.tar.gz"
