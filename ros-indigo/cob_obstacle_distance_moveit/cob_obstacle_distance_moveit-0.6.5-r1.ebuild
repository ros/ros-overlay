...
SRC_URI="https://github.com/ipa320/cob_manipulation-release/archive/release/indigo/cob_obstacle_distance_moveit/0.6.5-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
