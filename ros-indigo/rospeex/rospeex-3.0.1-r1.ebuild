...
DESCRIPTION="Meta package for rospeex packages."
HOMEPAGE="https://wiki.ros.org"
SRC_URI="https://bitbucket.org/rospeex/rospeex-release/get/release/indigo/rospeex/3.0.1-1.tar.gz -> ${P}-${PV}.tar.gz"
