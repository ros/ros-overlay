...
SRC_URI="https://github.com/ros-industrial-release/universal_robot-release/archive/release/indigo/ur5_moveit_config/1.1.10-1.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
