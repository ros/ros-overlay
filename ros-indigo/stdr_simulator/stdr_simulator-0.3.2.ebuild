...
SRC_URI="https://github.com/stdr-simulator-ros-pkg/stdr_simulator-release/archive/release/indigo/stdr_simulator/0.3.2-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
