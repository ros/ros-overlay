...
SRC_URI="https://github.com/ros-industrial-release/ros_canopen-release/archive/release/indigo/canopen_motor_node/0.6.8-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
