...
SRC_URI="https://github.com/yujinrobot-release/yujin_ocs-release/archive/release/indigo/yocs_ar_marker_tracking/0.6.4-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
