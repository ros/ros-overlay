...
SRC_URI="https://github.com/gt-rail-release/interactive_world-release/archive/release/indigo/interactive_world/0.0.12-0.tar.gz -> ${PN}-indigo-release-${PV}.tar.gz"
