...
SRC_URI="https://github.com/rosalfred-release/smarthome_common_driver-release/archive/release/indigo/smarthome_common_driver/0.1.61-0.tar.gz -> ${PN}-release-${PV}.tar.gz"
