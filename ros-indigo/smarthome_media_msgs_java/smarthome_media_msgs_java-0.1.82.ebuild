...
SRC_URI="https://github.com/rosalfred-release/smarthome_media_msgs_java-release/archive/release/indigo/smarthome_media_msgs_java/0.1.82-0.tar.gz -> ${P}-${PV}.tar.gz"
