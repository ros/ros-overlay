...
SRC_URI="https://github.com/yujinrobot-release/concert_services-release/archive/release/indigo/concert_service_waypoint_navigation/0.1.12-0.tar.gz -> ${P}-${PV}.tar.gz"
